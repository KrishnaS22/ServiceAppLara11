            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="overflow-x-auto">
                        <table
                            class="min-w-full bg-white dark:bg-gray-800 border-t border-b border-gray-200 dark:border-gray-700">
                            <thead>
                                <tr
                                    ...
                                    <th class="py-3 px-6 text-left w-48">Service</th>
                            ...
                            <tbody class="text-gray-600 dark:text-gray-200 text-sm font-light">
                                @foreach ($services as $service)
                                    <tr
                                        ...
                                        <td class="py-3 px-6">{{ $service->service }}</td>
                                        <td class="py-3 px-6">
                                            @if ($service->status == 1)
                                                <span
