                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <dl class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                ...
                                <dd
                                    ...
                                    {{ $complaint->staff->user->name }}
                                    @else
                                    The task is currently not assigned to anyone in the service staff.
                                    @endif
                                </dd>
                            </div>
                            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                ...
                                <dd class="mt-1 text-sm leading-6 sm:col-span-2 sm:mt-0">
                                    @if ($complaint->status)
                                        <span
                                            class="inline-block bg-[rgb(22,163,74,0.2)] text-green-600 dark:text-green-400 rounded px-2 py-1 text-xs">
                                            Active
                                        </span>
                                    @else
                                        <span
                                            class="inline-block bg-[rgba(163,22,22,0.2)] text-red-600 dark:text-red-400 rounded px-2 py-1 text-xs">
                                            Inactive
                                        </span>
                                    @endif
                                </dd>
                    ...
                    <div class="mt-6 text-right">
                        <a href="{{ route('complaints.index') }}"
                            class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600">
                            Back to Complaints
                        </a>
                    </div>
                </div>
